...
public class Schedule {
	...
	public Building whereAmI(String dayOfWeek, String timeOfDay) {
		...
		for (Section section : sections) {
            try {
                int endTime = parseTimeString(section.getCourseTime().getEndTime());
    ...
    public String getEndTimeOfLastClass(String dayOfWeek, String timeOfDay) {
        SortedSet<Section> sections = getSectionsForDayOfWeek(dayOfWeek);
        // Find which section ended just before timeOfDay
        Section lastSection = null;
        for (Section section : sections) {
        ...
        if (lastSection != null)
            return lastSection.getCourseTime().getEndTime();
        return null;
    }
